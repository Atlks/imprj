...
public class SearchService {
    ...
    public static void main(String[] args) throws Exception {
        SearchService receive = new SearchService();
        receive.start();
    ...
    public static void msgProcessor(Message message) {
		try {
            ...
            //获取到接收的数据
        	   ...
        	   if (message instanceof ActiveMQTextMessage) {
        		   ...
        		   // mqDelegate.execute(params, amqMessage.getText());
        		    ...
        		    JSONObject jo=   JSONObject.parseObject(msg );//JSON字符串转对象
        		    MongoClient mongoClient =mongodbConn. iniMongodb();
        			MongoDatabase database = mongoClient.getDatabase("db1");
        			MongoCollection<Document> collection = database.getCollection("msgCollTable");
...
//            consumer.close();
    ...
    public static void getFac() {
		  InputStream in = SearchService.class.getClassLoader().getResourceAsStream("cfg.ini"); 
			//也可以读取指定目录下的指定文件
        ...
        //连接密码
          String password = "";
        //连接地址
          String brokerURL = props.getProperty("mqurl");
        		  //"tcp://localhost:61616";
